...
function buildDailyReportContent({
  ...
  return [
    ...
    `- Marketplace period coverage: ${marketplaceCoverage.attempted} attempted — ${marketplaceCoverage.successful} successful, ${marketplaceCoverage.failedOrIncomplete} failed/incomplete, ${marketplaceCoverage.noActivity} no activity`,
    `- Marketplace scheduler health now: ${marketplaceCoverage.staleLeases} stale leases, ${marketplaceCoverage.overdue} overdue`,
    '',
